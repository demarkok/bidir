...
\begin{definition}[Equivalence] We define equivalence syntactically,
  as such, we do not maintain the typing information throughout the algorithm.

  The unification algorithm (and the equivalence relation) is defined
  as application of the following rules top to bottom:
...
\begin{itemize}
    ...
    \item[Base rules]
      \begin{mathpar}
        ...
        \and
        \Infer{}
              { (\evarassign{\hat{v}}{v}) \in \varphi \text{ or }
