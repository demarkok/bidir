...
\begin{mathpar}
  \begin{array}{llcl}
    ...
    \valtocomp{A} \bnfalt \pitype{x:A}{X} \bnfalt \force {v} \bnfalt \return{v}
...
\begin{mathpar}
  ...
  \Infer{$\subt$Eq}
   ...
   \Infer{let$\subt$}
         {
           \judgeacsubt{\varphi, \hat{v}}{\subst{X}{x}{\hat{v}}}{Y}{\varphi', \evarassign{\hat{v}}{v}}\\
           \judgeaequiv{\varphi'}
                       {\return{v}}
                       {\ctxtapp{\varphi'}{e}}
                       {\ctxtapp{\varphi'}{A}}{\varphi''}\\
         }
