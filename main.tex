...
\section{Reduction, equality, and normal forms}
...
\begin{definition}[Equivalence] We apply the following rules top to bottom:
...
\begin{itemize}
  \item[Base rules]
   ...
   \Infer{}
         ...
         {
           \judgeaequiv{\varphi}{t v}{t' v'}{\varphi''}
         }
   \and
   \Infer{}
         {
   ...
   \Infer{}
         {
           \judgeaequiv{\varphi, x:A}{t}{t'}{\varphi', x:A}
         }
         {
           \judgeaequiv{\varphi}{\fun{x:A}{t}}{\fun{x:A}{t'}}{\varphi'}
         }
   \and
   \Infer{}
         {
           \judgeaequiv{\varphi}{t}{t'}{\varphi'}\\
           \judgeaequiv{\varphi', x:A}{v}{v'}{\varphi'', x:A}
         }
         {
           \judgeaequiv{\varphi}{(\letval{x:A}{t}{v})}{(\letval{x:A}{t'}{v'})}{\varphi''}
         }
   \and
   \Infer{}
         {
         ...
         {
           \judgeaequiv{\varphi}{(\dletval{x:A}{t}{v})}{(\dletval{x:A}{t'}{v'})}{\varphi''}
         }
   \and     
   \Infer{}
         {
         ...
         {
           \judgeaequiv{\varphi}{\recsigma{v}{X}{t}}{\recsigma{v'}{X}{t'}}{\varphi''}
         }
   \and     
   \Infer{}
         {
         ...
         {
           \judgeaequiv{\varphi}{\receq{v}{X}{t}}{\receq{v'}{X}{t'}}{\varphi''}
         }
\end{mathpar}
...
\begin{definition}[Normal form]
  ...
  We say that the term $t$ is in normal form if and only if it is not reducible (i.e. 
...
\begin{definition} [x-neutral form]
  ...
  We say that the term $t$ is in $x$-neutral form if and only if
  \begin{enumerate*}
  \item[(i)]  $t$ is in normal form
    and
  \item[(ii)] for any term $v$ in normal form, $\subst{t}{x}{v}$ is in normal form.
  \end{enumerate*}
\end{definition}
