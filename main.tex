...
We denote algorithmic terms as $\rho$.
...
\newcommand{\fullterm}[2]{{#1}\,{#2}_1\dots{#2}_{\narg{#1}}}
...
\begin{mathpar}
  \begin{array}{llcl}
    ...
    \mbox{Terms} & \sigma, \tau & ::= & \fullterm{F}{\tau}
    \\[1em]
...
\begin{mathpar}
  \Infer{}{\judgeSok{x}{\tau_{1}}~\dots~\judgeSok{x}{\tau_{\narg{C}}}}{\judgeSok{x}{\fullterm{C}{\tau}}}
  \and
...
the subterms of $\tau$ but never on the top-level. Formally, it is defined as follows:
...
To make typing decidable, we restrict the system in several ways. In particular,
